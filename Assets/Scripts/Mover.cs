...
public abstract class Mover : Fighter
{
    ...
    protected virtual void UpdateMotor(Vector3 input)
	{
        ...
        hit = Physics2D.BoxCast(transform.position, boxCollider.size, 0, new Vector2(0, moveDelta.y), Mathf.Abs(moveDelta.y * Time.deltaTime), LayerMask.GetMask("Creatures", "Blocking"));
